  ...
  return (
    <div className="min-h-screen bg-bg">
      ...
      <header className="fixed top-4 left-1/2 -translate-x-1/2 z-50">
        <div className="flex items-center gap-2 rounded-full bg-surface/80 backdrop-blur-xl border border-border/50 shadow-nav px-2 py-1.5 max-w-[calc(100vw-2rem)] overflow-x-auto">
          <Link
            to="/"
